 ...
 <div class="container h-100 my-5 py-5">
		...
		<form action="addbook" method="post" autocomplete="on">
			<div class="row mb-3">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="bookName"
						name="bookName" placeholder="Book Name" required>
				</div>
			</div>
			<div class="row mb-3">
			...
			<div class="row mb-3">
				...
				<div class="col-sm-10">
					<textarea  type="text" rows="3" cols="20" class="form-control"
						id="Description" name="description" placeholder="Description" required></textarea>
				</div>
			</div>
			<div class="row mb-3">
				<label for="NoOfBooks" class="col-sm-2 col-form-label">No. Of Books</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" id="NoOfBooks" name="NoOfBooks"
						placeholder="No Of Books" required>
				</div>
			</div>
			<br> <br>
			...
			<table class="table table-striped text-center">
				...
				<tbody id="tableBody">
					<c:forEach items="${list}" var="item">
						...
						<tr>
							<td><input type="hidden" class="bookName" name="bookName" value="${item.bookname}">${item.bookname}</input></td>
							<td><input type="hidden" name="author" value="${item.author}">${item.author}</input></td>
